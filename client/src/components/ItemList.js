...
const ItemList = () => {
  ...
  const handleClaim = async (e) => {
    ...
    try {
      await api.post(`/items/${claimModal.item.id}/claim`, claimForm);
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="text-secondary">
            Browse through all lost and found items. Found something that
            belongs to you? Claim it!
          </p>
        </div>
          ...
          <div className="modal">
            ...
            <form onSubmit={handleClaim}>
              ...
              {claimModal.item?.type === "lost" && (
                <div className="form-group">
                  <p className="text-secondary">
                    By submitting this form, you're reporting that you found
                    this lost item. A moderator will review your claim and
                    contact you if approved.
                  </p>
                </div>
              )}
              ...
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  <div className="detail-item">
                    ...
                    <span>
                      {getTypeIcon(viewModal.item.type)} {viewModal.item.type}
                    </span>
                  </div>
                  <div className="detail-item">
                  ...
                  <div className="detail-item">
                    ...
                    <span>
                      {new Date(viewModal.item.created_at).toLocaleString()}
                    </span>
                  </div>
                </div>
              </div>
